...
"""
runner_strategy.py
Compiles and runs strategy cocotb tests under Icarus Verilog.
Usage:
    python runner_strategy.py [test_name]
"""
...
SOURCES = [
    ...
    str(TB_DIR       / "strategy_tb_wrapper.sv"),
]

SIM_BUILD = TB_DIR / "sim_build_strategy"
...
def run(testcase=None):
    ...
    env["COCOTB_TEST_MODULES"] = "test_strategy"
