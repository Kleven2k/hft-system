...
# ============================================================
# Nexys Video (Artix-7 XC7A200T) — HFT Project Constraints
# Source of truth: Digilent Nexys-Video-Master.xdc
# Only pins actively used by hft_top.v are uncommented.
# ============================================================
...
set_property -dict { PACKAGE_PIN G4  IOSTANDARD LVCMOS15 } [get_ports { sys_rst_n }]; #IO_L12N_T1_MRCC_35 Sch=cpu_resetn
...
# PHY management & reset
# eth_mdc/mdio live in bank 13 (LVCMOS25)
# eth_rst_b lives in bank 34 (LVCMOS33) — different bank, different standard!
...
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { phy_rst_n }]; #IO_25_34 Sch=eth_rst_b

# RGMII RX — incoming from PHY
